...
1. **Email**: security@mrdemonwolf.com
...
This policy covers the FangDash web app, API, and multiplayer race server. Score/race integrity issues (leaderboard forgery, token bypass, deterministic-PRNG exploits) are in scope. Report suspected cheating exploits privately rather than posting reproductions publicly.
