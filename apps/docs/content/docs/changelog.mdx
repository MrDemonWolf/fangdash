...
- Three opt-in mods selectable pre-game: **Fog**, **Headwind**, **Tremor**
- Each applies a 1.15x score multiplier; multiple mods stack multiplicatively (two = 1.322x, three = 1.521x)
- Score validation re-derives the multiplier server-side to prevent forgery
- Runs using a beta mod are unranked and excluded from the leaderboard

## Achievements

- Five new achievements (total now **21**): Fog Runner, Headwind Hero, Triple Threat, Endurance Wolf, Obstacle Gauntlet
