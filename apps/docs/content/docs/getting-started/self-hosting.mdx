...
| Admin panel shows "Forbidden" | User role is not `admin` or `dev` | Set `ADMIN_TWITCH_ID` secret before first login, or manually promote via D1 (see [Admin docs](/docs/getting-started/admin)) |
