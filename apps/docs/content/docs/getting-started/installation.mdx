...
<Callout type="info">
	**TL;DR** - Requires Node.js >= 20, Bun 1.3.10, a Cloudflare account, and a Twitch app - Clone →
...
<Callout type="info">
	**Generate a strong secret** with: `openssl rand -base64 32` — paste the output as your
	`BETTER_AUTH_SECRET`. Generate `RACE_TOKEN_SECRET` with `openssl rand -hex 32`.
</Callout>
